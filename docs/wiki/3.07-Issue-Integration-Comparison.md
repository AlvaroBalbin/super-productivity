...
- **Naming:** The **CalDAV resource** name is used as the label in the issue provider panel. When it is empty, the CalDAV URL is shown instead.
...
- **Naming:** The optional **Calendar name** is used as the label in the issue provider panel and in **Schedule → Calendar Visibility**. When it is empty, the host of the iCal URL is shown instead.
